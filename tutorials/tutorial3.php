...
?>            
            ...
            <div class="callout-box">
                ...
                <button class="multipleChoice" onclick="window.location.href='../quizzes/quiz3.html';">Go to Quiz 3: Traversing UNIX</button>
            </div>
            <p>
	        ...
	        <br><br>
            <div>
                <button class="multipleChoice centerButton" onclick="window.location.href='../quizzes/quiz3.html';">Go to Quiz 3: Traversing UNIX</button>
            </div>
            <div>
                <button class="multipleChoice backButton" onclick="window.location.href='tutorial2.html';">Go to Tutorial 2: UNIX Structure</button>
                <button class="multipleChoice nextButton" onclick="window.location.href='tutorial4.html';">Go to Tutorial 4: Manipulating UNIX Files and Directories</button>
            </div>
<?php
