...
?>      
            ...
            <h1 id="section2">Section 2: UNIX Structure</h1>
            ...
            <div>
                ...
                <p id="processes"><span class="text-bold">Processes</span> refer to the instance of a currently executing program. A perfect example of this being the use of commands in the UNIX shell. Whenever you type in a UNIX command, you are executing a program to interpret and run the command you desire!</p>
                <p id="files"><span class="text-bold">Files</span> on the other hand are a collection of data. These are created using a user's preferred text editor and or compiler and take up a form of physical space on a computer's storage devices via a designated file type. Some file types include .txt, .mp3, .exe, .html, and .css files. In UNIX, directories, or folders, are considered files but they have the important job of storing and grouping other files together. In addition to this, in UNIX, all of your PC hardware components are represented as files in the system hierarchy. This way, when the UNIX system needs to communicate with some portion of your system hardware, it can through its file equivalent.</p>
